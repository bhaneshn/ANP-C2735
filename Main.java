...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		while(true) {
			...
			System.out.println("Press 5: Update All Information of Employee");
			...
			case 2:
				...
				boolean isUpdate=EmployeeDAO.updateEmployee(empPhone);
			...
			case 3:
				...
				boolean isDelete=EmployeeDAO.updateEmployee(empId);
